...
from model.Initialization import weights_initialize_xavier_normal as weights_initialize_normal
...
class Field_Generator(nn.Module):
    ...
    def __init__(self, args, input_channel=1, output_channel=2):
        ...
        # self.conv_down1 = nn.Conv2d(in_channels=c1, out_channels=c1, kernel_size=(2,2), stride=(2,2), padding=(0,0))
        ...
        # self.conv_down2 = nn.Conv2d(in_channels=c2, out_channels=c2, kernel_size=(2, 2), stride=(2, 2), padding=(0, 0))
        ...
        # self.conv_down3 = nn.Conv2d(in_channels=c3, out_channels=c3, kernel_size=(2, 2), stride=(2, 2), padding=(0, 0))
        ...
        # self.conv_down4 = nn.Conv2d(in_channels=c4, out_channels=c4, kernel_size=(2, 2), stride=(2, 2), padding=(0, 0))
        ...
        # self.conv_T5 = CBR(in_channel=c4, out_channel=c4, use_norm=self.use_norm, lrelu_use=self.lrelu_use,
        #                    batch_mode=self.batch_mode, sampling='up')
        ...
        # self.conv_T6 = CBR(in_channel=c3, out_channel=c3, use_norm=self.use_norm, lrelu_use=self.lrelu_use,
        #                    batch_mode=self.batch_mode, sampling='up')
        ...
        # self.conv_T7 = CBR(in_channel=c2, out_channel=c2, use_norm=self.use_norm, lrelu_use=self.lrelu_use,
        #                    batch_mode=self.batch_mode, sampling='up')
        ...
        # self.conv_T8 = CBR(in_channel=c1, out_channel=c1, use_norm=self.use_norm, lrelu_use=self.lrelu_use,
        #                    batch_mode=self.batch_mode, sampling='up')
...
class ASPP(nn.Module):
    def __init__(self, in_channel, out_channel, use_norm, lrelu_use, batch_mode, rates=(6, 12, 18)):
        super(ASPP, self).__init__()
        self.use_norm = use_norm
        self.lrelu_use = lrelu_use
        self.batch_mode = batch_mode
        self.aspp = nn.ModuleList()
        self.aspp.append(CBR(in_channel=in_channel, out_channel=out_channel, kernel=1, padding=0,
                               stride=1, lrelu_use=self.lrelu_use, use_norm=self.use_norm, batch_mode=self.batch_mode))
        for r in rates:
            self.aspp.append(CBR(in_channel=in_channel, out_channel=out_channel, lrelu_use=self.lrelu_use,
                                 use_norm=self.use_norm, batch_mode=self.batch_mode, kernel=3, rate=r, padding=r, stride=1))

        # self.aspp.append(ASPP_pooling(in_channel=in_channel, out_channel=out_channel))

        self.projection = CBR(in_channel=self.aspp.__len__()*out_channel, out_channel=out_channel, lrelu_use=self.lrelu_use,
                                 use_norm=self.use_norm, batch_mode=self.batch_mode)
